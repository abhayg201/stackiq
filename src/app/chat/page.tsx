  ...
  return (
    <button
      ...
      style={{
        ...
        border: selected ? "1px solid rgba(22,163,74,0.3)" : "1px solid rgba(0,0,0,0.06)",
        backgroundColor: selected ? "rgba(22,163,74,0.06)" : "rgba(0,0,0,0.02)",
        cursor: "pointer",
        transition: "all 0.2s",
        textAlign: "center",
        boxShadow: selected ? "0 0 20px rgba(22,163,74,0.06)" : "none",
      }}
    >
      ...
      <span
        style={{
          ...
          fontWeight: 500,
          lineHeight: 1.3,
          color: selected ? "#16A34A" : "rgba(17,24,39,0.9)",
        }}
      >
        {tile.label}
      </span>
      {tile.description && (
        <span style={{ fontSize: "0.625rem", color: "rgba(107,114,128,0.6)", lineHeight: 1.3 }}>
          {tile.description}
        </span>
      )}
      {selected && (
...
function TypingIndicator() {
  return (
    <div style={{ display: "flex", gap: "0.625rem", alignItems: "flex-end" }} className="animate-msg-in">
      ...
      <div style={{ backgroundColor: "rgba(0,0,0,0.06)", borderRadius: "1rem 1rem 1rem 0.375rem", padding: "0.75rem 1rem" }}>
...
function ProgressBar({
  ...
  return (
    <div style={{ display: "flex", alignItems: "center", gap: "0.75rem", padding: "0.625rem 1.25rem", borderBottom: "1px solid rgba(0,0,0,0.06)" }}>
      <div style={{ flex: 1, height: "4px", backgroundColor: "rgba(0,0,0,0.06)", borderRadius: "2px", overflow: "hidden" }}>
        <div
          style={{ height: "100%", width: `${pct}%`, backgroundColor: "#16A34A", borderRadius: "2px", transition: "width 0.5s ease" }}
        />
      </div>
      <span style={{ fontSize: "0.625rem", fontFamily: "'IBM Plex Mono', monospace", color: "#6B7280", flexShrink: 0 }}>
        {phase === "ai" ? (
          ...
          >
            ...
            >
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                <div style={{ fontSize: "0.875rem", fontWeight: 600, color: "#111827" }}>StackIQ</div>
                <div style={{ fontSize: "0.625rem", fontFamily: "'IBM Plex Mono', monospace", color: "rgba(22,163,74,0.6)", display: "flex", alignItems: "center", gap: "0.375rem" }}>
              ...
              {Object.keys(userProfile).length > 0 && (
                <div style={{ display: "flex", gap: "0.25rem" }}>
                  {Object.keys(userProfile).slice(0, 3).map((key) => (
                    ...
                    >
                      <span style={{ color: "rgba(22,163,74,0.7)", fontSize: "0.5625rem", fontFamily: "'IBM Plex Mono', monospace", textTransform: "uppercase" }}>
                        {key.split("_")[0]}
                      </span>
                    </div>
                  ))}
                  {Object.keys(userProfile).length > 3 && (
                    <div style={{ backgroundColor: "rgba(0,0,0,0.03)", border: "1px solid rgba(0,0,0,0.06)", borderRadius: "0.25rem", padding: "0.125rem 0.5rem" }}>
                      <span style={{ color: "#6B7280", fontSize: "0.5625rem", fontFamily: "'IBM Plex Mono', monospace" }}>
                        +{Object.keys(userProfile).length - 3}
                      </span>
                    </div>
                  )}
            ...
            >
              {messages.map((msg, i) => {
                ...
                return (
                  <div key={i} style={{ display: "flex", justifyContent: "flex-end" }} className="animate-msg-in">
                    ...
                    >
                      <p style={{ fontSize: "0.8125rem", color: "#111827", lineHeight: 1.6 }}>{msg.content}</p>
                    </div>
                  </div>
                );
              })}
              ...
              {phase === "tiles" && currentTileStep && !typing && (
                <div style={{ paddingLeft: "2.25rem", display: "flex", flexDirection: "column", gap: "0.75rem" }} className="animate-msg-in">
                  {currentTileStep.subtitle && (
                    <p style={{ fontSize: "0.6875rem", fontFamily: "'IBM Plex Mono', monospace", color: "rgba(107,114,128,0.6)" }}>
                      {currentTileStep.subtitle}
                    </p>
                  )}
                  <div
              ...
              {phase === "done" && (
                <div style={{ paddingLeft: "2.25rem" }} className="animate-msg-in">
                  ...
                  >
                    <Sparkles size={22} color="#16A34A" style={{ margin: "0 auto 0.75rem" }} />
